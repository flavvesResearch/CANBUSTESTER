...
TRANSLATIONS: Dict[str, Dict[str, Any]] = {
    "tr": {
        ...
        "code_source_excel_decimal": "Excel ile decimal gönder",
        "code_source_manual": "Manuel aralık",
        "code_excel_select": "Excel dosyası seçin",
        "decimal_target_signal": "Hedef Sinyal",
        "select_signal": "Sinyal seçin",
        "select_signal_first": "Lütfen bir sinyal seçin.",
        ...
        # Fault Injection
        "fault_injection": "Hata Enjeksiyon Testleri",
        "fault_type": "Hata Tipi",
        "fault_bit_flip": "Rastgele Bit Hatası",
        "fault_dlc_mismatch": "DLC Uyumsuzluğu",
        "fault_out_of_range": "Sınır Dışı Değerler",
        "fault_random_data": "Rastgele Veri",
        "fault_zero_data": "Sıfır Veri",
        "fault_max_data": "Maksimum Veri",
        "bit_flip_count": "Bozulacak Bit Sayısı",
        "bit_flip_help": "Verinin rastgele bitlerini değiştirir.",
        "dlc_value": "DLC Değeri",
        "dlc_help": "Gerçek veri uzunluğundan farklı DLC gönderir.",
        "target_signal": "Hedef Sinyal",
        "range_multiplier": "Sınır Aşım Çarpanı",
        "range_help": "Seçilen sinyale min/max sınırlarını aşan değer atar.",
        "fault_interval": "Gönderim Aralığı (sn)",
        "fault_count": "Toplam Gönderim Sayısı",
        "start_fault_test": "Hata Testini Başlat",
        "stop_fault_test": "Testi Durdur",
        "fault_test_ready": "Hata testi hazır.",
        "fault_test_running": "Hata testi çalışıyor",
        "fault_test_started": "Hata testi başlatıldı.",
        "fault_test_stopped": "Hata testi durduruldu.",
        "fault_test_completed": "Hata testi tamamlandı.",
    ...
    "en": {
        ...
        "code_source_excel_decimal": "Send from Excel (decimal)",
        "code_source_manual": "Manual range",
        "code_excel_select": "Select Excel file",
        "decimal_target_signal": "Target Signal",
        "select_signal": "Select signal",
        "select_signal_first": "Please select a signal.",
        ...
        "fault_bit_flip": "Random Bit Flip",
        "fault_dlc_mismatch": "DLC Mismatch",
        "fault_out_of_range": "Out of Range Values",
        "fault_random_data": "Random Data",
        "fault_zero_data": "Zero Data",
        "fault_max_data": "Maximum Data",
        "bit_flip_count": "Number of Bits to Flip",
        "bit_flip_help": "Flips random bits in the data.",
        "dlc_value": "DLC Value",
        "dlc_help": "Sends a different DLC than actual data length.",
        "target_signal": "Target Signal",
        "range_multiplier": "Range Overflow Multiplier",
        "range_help": "Assigns values beyond min/max limits to selected signal.",
        "fault_interval": "Send Interval (sec)",
        "fault_count": "Total Send Count",
        "start_fault_test": "Start Fault Test",
        "stop_fault_test": "Stop Test",
        "fault_test_ready": "Fault test ready.",
        "fault_test_running": "Fault test running",
        "fault_test_started": "Fault test started.",
        "fault_test_stopped": "Fault test stopped.",
        "fault_test_completed": "Fault test completed.",
        "sent_count": "Sent",
        "of": "/",
    }
}
